 ...
 *         to do something if the alarm is or isn't set & it is or isn't a week day. 
 *
...
//currently it's saying, i is 11, when i is greater than 10 it will continue
//to print out and increase. to fix that we need to either change the value
//of i, adjust the condition to something that will eventually be reached,
//or remove the loop.
   for (let i = 11; i < 15; i++) { 
      console.log(i);   
   } 
